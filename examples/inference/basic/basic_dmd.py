...
def main():
    ...
    with nvtx_range("basic_dmd:model_load"):
    ...
    with nvtx_range("basic_dmd:sampling_setup"):
    ...
    with nvtx_range("basic_dmd:generate_video_1"):
    ...
    prompt2 = (
        ...
        "cinematic.")
    start_time = time.perf_counter()
    with nvtx_range("basic_dmd:generate_video_2"):
